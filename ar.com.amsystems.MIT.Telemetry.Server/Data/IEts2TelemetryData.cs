...
namespace ar.com.amsystems.Telemetry.Server.Data
{
    ...
    public interface IEts2Truck
    {
        ...
        /// Example: 105809.25
        /// </summary>
        float f_velocimetro { get; }
        /// <summary>
        /// Speed selected for the cruise control in km/h.
        /// Example: 75
        /// </summary>
        float f_VelocidadCrucero { get; }
