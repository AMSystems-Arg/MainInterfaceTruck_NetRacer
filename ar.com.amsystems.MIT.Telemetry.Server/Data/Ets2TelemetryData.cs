...
namespace ar.com.amsystems.Telemetry.Server.Data
{
    class Ets2TelemetryData : IEts2TelemetryData
    {
        ...
        public IEts2Game Mod => new Ets2Game(_rawData);
        public IEts2Truck Trayecto => new Ets2Truck(_rawData);
        public IEts2Trailer Trailer => new Ets2Trailer(_rawData);
        public IEts2Job Chofer => new Ets2Job(_rawData);
        public IEts2Navigation Recorrido => new Ets2Navigation(_rawData);
    }
    ...
    class Ets2Game : IEts2Game
    {
        ...
        public bool b_Connected => _rawData.Struct.ets2_telemetry_plugin_revision != 0 &&
    ...
    class Ets2Truck : IEts2Truck
    {
        ...
        public string s_Id => Ets2TelemetryData.BytesToString(_rawData.Struct.truckMakeId);
        public string s_Make => Ets2TelemetryData.BytesToString(_rawData.Struct.truckMake);
        public string s_Model => Ets2TelemetryData.BytesToString(_rawData.Struct.truckModel);

        /// <summary>
        /// Velocidad del camion en km/h.
        /// </summary>
        public float f_Speed => _rawData.Struct.speed * 3.6f;

        /// <summary>
        /// Velocidad de Control Cruceroe en km/h.
        /// </summary>
        public float f_VelocidadCrucero => _rawData.Struct.cruiseControlSpeed * 3.6f;

        public bool CruiseControlOn => _rawData.Struct.cruiseControl != 0;
        public float f_velocimetro => _rawData.Struct.truckOdometer;
        public int i_cambio => _rawData.Struct.gear;
        public int i_DisplCambio => _rawData.Struct.displayedGear;
        ...
        public float f_rpm => _rawData.Struct.engineRpm;
        public float f_rpm_max => _rawData.Struct.engineRpmMax;
        public float f_gasoil => _rawData.Struct.fuel;
        public float f_capaci_tanque => _rawData.Struct.fuelCapacity;
        ...
        public float f_ChoferVolante => _rawData.Struct.userSteer;
        public float f_ChoferAccel => _rawData.Struct.userThrottle;
        public float f_ChoferFreno => _rawData.Struct.userBrake;
        public float f_ChoferEnbrague => _rawData.Struct.userClutch;
