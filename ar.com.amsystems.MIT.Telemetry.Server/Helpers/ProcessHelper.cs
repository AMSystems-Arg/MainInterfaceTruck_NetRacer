...
namespace ar.com.amsystems.Telemetry.Server.Helpers
{
    public static class ProcessHelper
    {
            ...
            int timeoutInSeconds = 10)
        {
            ...
            Log.InfoFormat("Corriendo Linea de Comando: \r\n{0} {1}", exeFileName, arguments);
            ...
            using (var process = Process.Start(info))
            {
                if (process == null || process.Handle == IntPtr.Zero)
                    throw new Exception("Fallo al levantar el proceso: " + exeFileName);

                // Desabilitado ReSharper AccessToDisposedClosure
                ...
                cancellationSource.Token.Register(
                    () =>
                    {
                        // Desabilitado ReSharper sobre AccessToModifiedClosure
                        if (!exited)
                            process.Kill();
                    });
