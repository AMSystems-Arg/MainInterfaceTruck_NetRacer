...
namespace ar.com.amsystems.Telemetry.Server
{
    static class Program
    {
        ...
        {
            // Validador de Instancias activas
            CreateMutex(0, -1,
            ...
            {
                MessageBox.Show(@"Otra instancia MainInterfaceTruckServer Corriendo!", @"Advertencia",
            ...
            Application.Run(new MIT_Server()); //MIT_Server() //Interfaz_Main
        }
    }
}
